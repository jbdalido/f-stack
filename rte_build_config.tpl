 ...
 * @file
 *
 * RTE Configuration API (generated)
 *
 * This file contains build-time configuration parameters
 * generated from the build environment.
 */
#define RTE_VECT_DEFAULT_SIMD_BITWIDTH 1
#define CPU_SETSIZE 1
#define RTE_HAS_CPUSET 1
...
#define RTE_GPU_CUDA 1
#define BNXT_TF_APP_ID 0
#define RTE_HAS_LIBFDT 1
#define RTE_LIBRTE_IXGBE_BYPASS 1
...
#define RTE_NET_IPN3KE 1
#define RTE_NET_IXGBE 1
#define RTE_NET_MANA 1
